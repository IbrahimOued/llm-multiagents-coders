...
# Stock lookup agent
def stock_lookup_agent_factory(state: dict) -> ReActAgent:
...
# Auth Agent
def auth_agent_factory(state: dict) -> ReActAgent:
...
def account_balance_agent_factory(state: dict) -> ReActAgent:
